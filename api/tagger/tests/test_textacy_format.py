...
class TestTextacyFormatting(unittest.TestCase):
    ...
    def test_sgrank(self):
        ...
        assert dict(keywords) == \
                        dict([(u'massless spin-1/2 particle', 0.15387941999481636),
                        (u'logical inference treatment', 0.11715332737705884),
                        (u'logical inference approach', 0.09136901016959438),
                        (u'continuum limit', 0.08033973111784386),
                        (u'continuum space', 0.06630463582851502),
                        (u'pauli equation', 0.03132777999751102),
                        (u'creutz model', 0.026581337388402043),
                        (u'fundamental obstacle', 0.02639697723912133),
                        (u'continuum description', 0.026300408365873586),
                        (u'proper treatment', 0.025135452800462643)])
